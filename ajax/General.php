		...
		<div class="card" style="height:100%;cursor:pointer;" onclick="loadHistoricalData('<?php echo $result['hostname'];?>', 'AgentVersion');">
		  <div class="card-body" style="padding:10px;">
			...
			<?php if($agentVersion != $siteSettings['general']['agent_latest_version']){?>
					<button class="btn-sm btn btn-success" onclick='sendCommand("C:\\\\SMG_RMM\\\\Update.bat", "", "Update Agent", 2);' style="background:<?php echo $siteSettings['theme']['Color 4'];?>;float:right;display:inline;" title="Update to <?php echo $siteSettings['general']['agent_latest_version'];?>">
