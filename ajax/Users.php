					...
					<tbody>
						...
						<tr>
						  ...
						  <td><?php echo $user['Disabled'];?>
							...
							<?php }else{ ?>
								<button onclick='sendCommand("net", "user <?php echo $user['Name']; ?> password", "Reset Password For <?php echo $user['Name']; ?>");' style="float:right;margin-left:5px;" title="Reset To Simple Password?" class="btn btn-sm btn-primary"><i class="fas fa-star-of-life"></i></button>&nbsp;
