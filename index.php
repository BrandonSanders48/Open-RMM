...
<html>
	<head>
		<title>SMG RMM | Management</title>
		<meta http-equiv="content-type" content="text/html; charset=utf-8">
		<meta name="viewport" content="width=device-width, initial-scale=1.0">
		<!--- Font Awesome --->
		<link rel="stylesheet" href="css/all.min.css"/>
		<script src="js/all.min.js"></script>
		<script src="https://cdn.tiny.cloud/1/kdsnrszwoxdwc9f80ckwo8skp7ltlz1io93n9l8a9j2hrkvb/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
		<!-- jquery-->
			...
			<nav style="overflow:auto;width:200px" id="sidebar">
				<ul class="list-unstyled components" style="padding:20px;margin-top:25px;">
					...
					<div style="margin-top:20px;text-align:center;" class="notes">
							<h6><b>Notes</b>
							<button data-toggle="modal" data-target="#noteModal" title="Create New Note" style="float:right;margin-top:-5px" class="btn btn-sm"><i class="fas fa-edit"></i></button>
							</h6>
							<?php
							$count = 0;
