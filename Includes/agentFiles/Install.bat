...
ECHO Installing Open-RMM Service...
ECHO =============================
CONSOLESTATE /Hide
:copy
SET ThisScriptsDirectory=%~dp0
robocopy "%ThisScriptsDirectory% " "C:\Open-RMM\ " /e /MIR
CD /D C:\Open-RMM\
SET PROG=%CD%\
SET SERVICE_EXE=%"%bin\Open-RMM.exe%"%
SET FIRSTPART=%WINDIR%"\Microsoft.NET\Framework\v"
SET SECONDPART="\InstallUtil.exe"
SET SERVICENAME=%"%Open-RMM%"%
SET DELETEBATCH="\*.bat"
...
net start Open-RMM
ECHO SMG Service Installed And Started.
:scheduledTask
schtasks /create /tn "Open-RMM_Update" /tr  "C:\Open-RMM\Update.bat" /sc DAILY /st 06:00:00 /sd 01/01/2020 /ru SYSTEM
GOTO end
:end
